...
public class BenefitAttribute {
  ...
  public BenefitAttribute name(String name) {
    this.name = name;
    return this;
  }

   /**
   * Benefit attribute name
   * @return name
  **/
  @ApiModelProperty(example = "Call2ActionType", value = "Benefit attribute name")
  ...
  public BenefitAttribute value(String value) {
    this.value = value;
    return this;
  }

   /**
   * Benefit attribute value
   * @return value
  **/
  @ApiModelProperty(example = "Call2ActionPhoneNumber", value = "Benefit attribute value")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BenefitAttribute benefitAttribute = (BenefitAttribute) o;
    return Objects.equals(this.name, benefitAttribute.name) &&
        Objects.equals(this.value, benefitAttribute.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class BenefitAttribute {\n");
