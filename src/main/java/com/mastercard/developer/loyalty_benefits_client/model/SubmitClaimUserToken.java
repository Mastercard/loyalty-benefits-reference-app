...
public class SubmitClaimUserToken {
  public static final String SERIALIZED_NAME_TOKEN = "token";
  @SerializedName(SERIALIZED_NAME_TOKEN)
  private String token;

  public SubmitClaimUserToken token(String token) {
    this.token = token;
    return this;
  }
   ...
   * @return token
  **/
  @ApiModelProperty(example = "EkRKarafAVJkljljfafkljeiwie...", value = "Encrypted user data token")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SubmitClaimUserToken submitClaimUserToken = (SubmitClaimUserToken) o;
    return Objects.equals(this.token, submitClaimUserToken.token);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubmitClaimUserToken {\n");
